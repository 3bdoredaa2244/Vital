...
// Optional Open Graph / favicon overrides. Left empty so buildHead() falls back
// to the DEFAULT_TITLE / DEFAULT_DESCRIPTION above.
...
function buildHead(meta: AppMeta) {
  ...
  return {
    ...
    links: [
      ...
      // Falls back to the bundled logomark so the browser's automatic
      // /favicon.ico request doesn't 404.
      { rel: "icon", href: favicon ?? "/assets/vital-logomark.svg" },
    ],
  };
}
  ...
  return (
    <div className="flex min-h-dvh items-center justify-center bg-[#FBF6EC] px-4">
      <div className="mx-auto max-w-md text-center">
        <span className="text-2xl font-bold text-[#20201C]">404</span>
        <h1 className="mt-2 text-2xl font-bold text-[#20201C]">Page not found</h1>
