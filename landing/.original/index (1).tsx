    ...
    <div className="min-h-screen selection:bg-[#E0A98C] selection:text-[#20201C]" style={{ fontFamily: '"Inter", sans-serif' }}>
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 h-[60px] flex items-center justify-between px-6 md:px-10 transition-all duration-300 ${
        ...
        <div className="hidden md:flex items-center gap-4">
          <a href="#pricing" className="text-sm font-medium text-[#6B6459] hover:text-[#20201C] px-4 py-2 border border-[#E7DECC] rounded-lg transition-all hover:border-[#C2603C]">
            Sign In
          </a>
          <a href="#pricing" className="text-sm font-semibold text-[#FBF6EC] bg-[#C2603C] px-5 py-2.5 rounded-lg hover:bg-[#A34E30] shadow-sm hover:shadow-[0_4px_16px_rgba(194,96,60,0.25)] transition-all">
            Get Started &rarr;
          </a>
        </div>
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-40 bg-[#FBF6EC] flex flex-col justify-center px-10 gap-8 animate-fade-in md:hidden">
          ...
          <div className="flex flex-col gap-4 mt-4">
            <a href="#pricing" onClick={() => setMobileMenuOpen(false)} className="w-full text-center py-3.5 rounded-lg border border-[#E7DECC] text-[#20201C] font-semibold">
              Sign In
            </a>
            <a href="#pricing" onClick={() => setMobileMenuOpen(false)} className="w-full text-center py-3.5 rounded-lg bg-[#C2603C] text-[#FBF6EC] font-semibold shadow-md">
              Get Started &rarr;
            </a>
          </div>
        </div>
